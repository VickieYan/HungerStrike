...
<style type="text/css">
	.homelist{width: 100%;height:1.78rem;background: #fff;text-align: left;margin:.1rem 0;}
	.homelist-title{height: .37rem;border-bottom: 1px solid #EFEFEF;line-height: .37rem;overflow: hidden;padding: 0 .1rem;}
	.homelist-title span{font-size: .15rem;color: #000;float: left;}
	.homelist-wapper{height: 1.4rem;overflow: hidden;white-space: nowrap;padding: 0 .1rem;}
	.homelist .swiper01 .swiper-slide{width: .76rem}
</style>